...
# Models for the Azure OpenAI chat
public enum AZURE_OPEN_AI_MODEL_NAMES {
    ...
    GPT_35_TURBO_16K_0613 = "gpt-35-turbo-16k-0613"
}
...
public isolated client class OpenAiModel {
    *Model;
    ...
    public isolated function init(string apiKey, OPEN_AI_MODEL_NAMES modelType, string serviceUrl = OPENAI_SERVICE_URL,
        ...
        chat:Client|error llmClient = new (config);
...
public isolated client class AzureOpenAiModel {
    *Model;
    ...
    # + modelType - The OpenAI model name as constant from AZURE_OPEN_AI_MODEL_NAMES enum 
    ...
    # + return - Error if the model initialization fails
    public isolated function init(string serviceUrl, string apiKey, AZURE_OPEN_AI_MODEL_NAMES modelType, string deploymentId,
            string apiVersion, int maxToken = DEFAULT_MAX_TOKEN_COUNT, decimal temperature = DEFAULT_TEMPERATURE,
        ...
        azure_chat:ConnectionConfig azureConfig = {
            auth: {apiKey},
            httpVersion: connectionConfig.httpVersion,
            http1Settings: http1Settings,
            http2Settings: connectionConfig.http2Settings,
        ...
        azure_chat:Client|error llmClient = new (azureConfig, serviceUrl);
        if llmClient is error {
